exports.run = async (client, message) => {
  ...
  return message.channel.send(`**Şimdi bu kanala giriş yaptım** ${message.member.voiceChannel}. **Kopmaya Hazır Ol!**`);
};
...
exports.help = {
  name: "gir",
  description: "Bulunduğunuz ses kanalına girer.",
  usage: "-gir veya -katıl",
  usageDelim: "",
};